...
class Menu(QMainWindow):
    def __init__(self):
        ...
        self.banco = sqlite3.connect('banco_aluno.db')
        ...
        self.banco = sqlite3.connect('banco_livro.db')
        self.csr = self.banco.cursor()
        ...
        self.banco = sqlite3.connect('banco_aluguel.db')
        self.csr = self.banco.cursor()
    ...
    def pesquisar_u(self):
        ...
        print(self.texto)
        self.banco = sqlite3.connect('banco_aluguel.db', timeout=1)
        self.csr = self.banco.cursor()
    ...
    def pesquisar_l(self):
        ...
        print(self.texto)
        self.banco = sqlite3.connect('banco_livro.db', timeout=1)
        self.csr = self.banco.cursor()
    ...
    def pesquisar_a(self):
        ...
        print(self.texto)
        self.banco = sqlite3.connect('banco_aluno.db', timeout=1)
        self.csr = self.banco.cursor()
